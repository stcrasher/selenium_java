...
public class LocatingElementListHandler<T> implements InvocationHandler {
    ...
    public LocatingElementListHandler(ElementLocator locator, ClassLoader loader, Class<T> clazz) {
    ...
    public Object invoke(Object object, Method method, Object[] objects) throws Throwable {
        ...
        try {
            ...
            String message = String.format(
                    ...
                    method.getName(), locator.toString(),
                    e.getCause());
            System.out.println(message);
            return false;
        }
